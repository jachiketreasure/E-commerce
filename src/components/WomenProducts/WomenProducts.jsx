...
import { fetchWomenProducts, fetchWomenShoesProducts } from '../../api/products';
            ...
            <div className="container">
                <div className="row">
                    ...
                    <p className="text-muted m-0 mb-3">
                        Stylish and modern outfits for women
                    </p>
                    ...
                    <>
                        ...
                        >
                            <div className="modall">
                                <div
                                    className="image-modall d-flex justify-content-between position-relative"
                                    style={{
                                ...
                                >
                                    ...
                                    <div className="content-modall w-50 m-auto">
                                        ...
                                        />
                                        <p
                                            className="px-2 py-1 my-2 text-light fw-bold"
                                            style={{
